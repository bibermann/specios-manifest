...
die Daten werden von den Mitgliedern über einen Internetzugang erstellt.
...
knitr::include_graphics("content/3-system/speciosgraph2_small.png")
```
...
welche zur Erfassung des jeweiligen Sachverhaltes benötigt werden (Kompetenzwichtung).
...
Vor Manipulationen kann man sich mit Hilfe verteilter Gegenrechnungen, zertifizierter Systemschnappschüsse und spezieller Notpläne schützen.
\index{Notpläne}Mit Notplänen sind (gedruckte) zertifizierte Repräsentationen der wesentlichen abstrahierten Regeln gemeint,
welche in jedem Haushalt oder ähnlichen, möglicherweise größeren Gruppierungen gehalten
und durch einen sicheren, möglichst persönlichen Mehrheitsentscheid aktiviert werden können.
