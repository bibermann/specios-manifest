...
Entsprechende Tools sorgen für die Vernetzbarkeit der Daten.
Außerdem ist der Ursprung aller Daten jederzeit validierbar;
natürlich auch dann, wenn aus ihnen automatische Schlussfolgerungen gezogen werden.
...
Ebenso wird es Mechanismen geben, die einem Tunnelblick entgegenwirken.
...
direkt betroffene Person besser urteilen können.
...
ist sowohl der extrapolierte Wohlstandslevel der Lebewesen in ferner Zukunft
als auch der minmale zwischenzeitliche Wohlstandslevel bestimmter Arten 
oder gar einzelner Lebewesen.
Specios will den Wohlstand nicht nur maximieren, er darf auch niemals unter ein gewisses Niveau fallen,
